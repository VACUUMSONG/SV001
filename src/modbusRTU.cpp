...
// 前进速度 20RPM
void ModbusRTU::mb_Set_Motor_Forward(){
	uint8_t mb_setSpeed_FW[13] = {0x01, 0x10, 0x20, 0x88, 0x00, 0x02, 0x04, 0xFF, 0xEC, 0x00, 0x14, 0x92, 0x46};
	mb_Send_Cmd(mb_setSpeed_FW,13);
}
//  后退速度 20RPM
void ModbusRTU::mb_Set_Motor_Backward(){
	uint8_t mb_setSpeed_BW[13] = {0x01, 0x10, 0x20, 0x88, 0x00, 0x02, 0x04,  0x00, 0x14, 0xFF, 0xEC, 0x63, 0xD1};
	mb_Send_Cmd(mb_setSpeed_BW,13);
}

// 左转
void ModbusRTU::mb_Set_Motor_Right(){

	uint8_t mb_setSpeed_Right[13] = {0x01, 0x10, 0x20, 0x88, 0x00, 0x02, 0x04, 0xFF, 0xEC, 0xFF, 0xEC, 0xD2, 0x34};
	mb_Send_Cmd(mb_setSpeed_Right,13);
	delay(300);
	// 停止
	mb_Set_Motor_Stop();
}
...
// 右转
void ModbusRTU::mb_Set_Motor_Left(){

	uint8_t mb_setSpeed_Left[13] = {0x01, 0x10, 0x20, 0x88, 0x00, 0x02, 0x04,  0x00, 0x14, 0x00, 0x14, 0x23, 0xA3};
	mb_Send_Cmd(mb_setSpeed_Left,13);
	delay(300);
	// 停止
	mb_Set_Motor_Stop();
